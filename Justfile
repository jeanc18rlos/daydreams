...
#
# Everything here is a plain cargo invocation from the repository root, which is where the
# game must be run from until the asset-root resolution lands: Meshes/, Shaders/, Textures/
# and assets/ are read by relative path.
